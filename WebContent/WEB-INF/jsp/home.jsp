...
<html>
  ...
  <!-- 
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="row">
			<div class = "col-md-7">
				<div class="collapse navbar-collapse col-md-8 col-md-offset-5">
					<ul class="nav navbar-nav">
						<li id="MyContents_btn"><a href="#"><img src = "resources/image/icon_unover.png"/></a></li>
						<li id="History_btn"><a href="#"><img src = "resources/image/icon_unover.png"/></a></li>
						<li id="Config_btn"><a href="#"><img src = "resources/image/icon_unover.png"/></a></li>
					</ul>
				</div>
			</div>
			<div class = "col-md-3">
